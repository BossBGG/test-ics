...
// console.log(dateTimeLast.value);
</script>
    ...
    <div class="bg_field_gray rounded">
      <div class="row q-pa-sm">
        <div class="text-sub-head q-px-sm q-pt-md text-weight-600">
          สถานะการติดต่อผู้ใช้ไฟฟ้า
        </div>
        <div class="q-pa-sm col-12" v-if="CAN_EDIT.REQUEST.value">
        ...
        <div class="q-pa-sm col-12 col-md-12" v-if="CAN_EDIT.REQUEST.value">
          <q-input
            :readonly="!CAN_EDIT.REQUEST.value"
            v-model="text"
