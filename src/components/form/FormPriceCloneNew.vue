	...
	<div class="wrapper-price-clone q-mt-lg">
		<div class="box_table_quotation">
			<div class="sub_table">
				...
				>
					<div class="box_table" v-if="!isDisabled">
						<div class="item col_id">
							<div class="box_align">
						...
						<div class="item col_unit col-desktop discount">
							<q-input
								...
								filled
								class="input_filled_custom qt-discount"
								type="text"
								bg-color="white"
								input-class="text-right"
								@keypress="allowOnlyPrice"
		...
		<div class="q-mt-md text-right" v-if="!isDisabled">
			<q-btn
				flat
				icon="add"
				label="เพิ่มรายการ"
				class="q-btn-size-small bg-secondary text-white add-qt"
				@click="cloneForm"
			/>
		</div>
