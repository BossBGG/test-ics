      ...
      <div class="row q-pa-sm">
        ...
        <div class="col-12 q-pa-sm" v-else>
          <q-field filled :label="businessPartner?.legal_type == 3
            ? 'ชื่อนิติบุคคล'
            : 'ชื่อผู้ใช้ไฟ'
            " readonly stack-label bg-color="white" class="label_q_field">
            <template #control>
              <div class="full-width no-outline color_text_input self-center font-size-normal" tabindex="0">
        ...
        <AddressInput v-model="addressBillingForm" v-model:loading="addressLoading" :disable="useArdressIDcode"
