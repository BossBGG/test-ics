<!-- src/components/alert/AlertConfirmSave.vue -->
  ...
  <q-dialog v-model="isVisible" persistent>
    <q-card class="alert-card">
      ...
      <q-bar class="alert-header">
        <span class="alert-title">บันทึก{{isCreate ? 'สร้าง' : 'แก้ไข'}}กลุ่มวัสดุและอุปกรณ์</span>
      </q-bar>
      ...
      <q-card-section class="alert-content">
        ...
        <div class="message-container">
          <p class="save-message">
            ท่านต้องการ{{isCreate ? 'สร้าง' : 'แก้ไข'}}รายการ <span class="highlight">'ใช่ หรือ ไม่'</span>
          </p>
        </div>
      </q-card-section>
