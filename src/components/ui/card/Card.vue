...
const handleCardClick = () => {
  router.push(`/new_and_announce/${props.data.id}`);
};
</script>
...
<template>
  <div class="card-container" @click="handleCardClick">
    ...
    <div class="card-image-section">
      <img
        :src="data.image || '/assets/images/test-image.png'"
        :alt="data.title"
        class="card-image"
        @error="$event.target.src = '/assets/images/test-image.png'"
      />
      <!-- Status Badge -->
      <div v-if="data.status === 'new'" :class="['status-badge', statusClass]">
        {{ statusLabel }}
      </div>
    </div>
