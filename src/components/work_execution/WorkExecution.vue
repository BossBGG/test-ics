...
<template>
  <CardCollapse title="ผลปฏิบัติงาน" icon="/assets/images/calendar.png">
    <div class="py-4">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div class="flex flex-col gap-4">
          ...
          <div class="flex flex-col gap-5">
            <div class="flex flex-col gap-2">
              <label class="text-sm font-medium text-gray-700">วันที่และเวลาเริ่มปฏิบัติงาน</label>
              <q-input
            ...
            <div class="flex flex-col gap-2">
              <label class="text-sm font-medium text-gray-700">วันที่และเวลาปฏิบัติงานเสร็จ</label>
              <q-input
        ...
        <div class="flex flex-col">
          <div class="h-full min-h-[300px]">
            <div class="mb-3">
              <button 
                class="flex items-center justify-center gap-2 w-full bg-[#69306D] hover:bg-[#5a285d] text-white font-medium py-3 px-5 rounded-lg transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg"
            ...
            <!-- Placeholder Map -->
            <div class="flex-1 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 flex items-center justify-center min-h-[250px]">
              <div class="text-center text-gray-500">
                <q-icon name="map" size="48px" class="text-gray-400" />
                <p class="text-base mt-2 mb-1 text-gray-700">แผนที่แสดงตำแหน่งปฏิบัติงาน</p>
      ...
      <!-- Summary Section -->
      <div v-if="hasAnyDate" class="p-5 bg-gray-50 rounded-lg border border-gray-200">
        <h4 class="text-base font-semibold text-gray-700 mb-4">สรุปข้อมูลการปฏิบัติงาน</h4>
