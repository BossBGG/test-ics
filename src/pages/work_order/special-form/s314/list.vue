...
<template>
  <content-container
    :breadcrumbs="[
      ...
      { text: 'สร้างใบสั่งงาน ขอเช่าฉนวนครอบสายไฟฟ้า' },
    ]"
  >
    <template #menu>
    ...
    <div v-if="currentStep === 0">
      ...
      <CustomerInfo :data="customerData" @update:data="updateCustomerData">
        ...
        <template #additional-content>
          ...
          @update:data="updateInsulatorDateData"
          />
    ...
    <div v-else-if="currentStep === 3">
      ...
      <CardCollapse title="วันที่เช่าฉนวนครอบสายไฟฟ้า" icon="/assets/images/doc.png">
        <InsulationDateSelector 
          :data="InsulatorDateData"
          @update:data="updateInsulatorDateData"
          />
      ...
      <CardCollapse title="ฉนวนครอบสายไฟฟ้า" icon="/assets/images/doc.png">
        <InsulatorList />
      </CardCollapse>
