...
<template>
  <content-container
    :breadcrumbs="[
      ...
      { text: 'สร้างใบสั่งงาน ขอตรวจสอบระบบไฟฟ้าพร้อมออกใบรับรอง' },
    ]"
  >
    <template #menu>
    ...
    <div v-else-if="currentStep === 3">
      ...
      <CardCollapse title="ระดับแรงดันไฟฟ้า" icon="/assets/images/doc.png">
        <VoltageLevel />
      </CardCollapse>
...
import TransformerDetail from "~/pages/work_order/special-form/s308/TransformerDetail.vue";
