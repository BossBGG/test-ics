    ...
    <div class="additional-data-container">
      <div class="data-row">
        ...
        <div class="data-group">
          <label class="data-label">ระยะจากแผงโซล่าเซลล์ ถึง อินเวอร์เตอร์</label>
          <div class="input-with-unit">
            <q-input
              ...
              min="0"
              step="0.01"
              @update:model-value="(value) => updateField('batteryDistance', value)"
            ></q-input>
        ...
        <div class="data-group">
          ...
          <div class="input-with-unit">
            <q-input
              ...
              min="0"
              step="0.01"
              @update:model-value="(value) => updateField('inverterDistance', value)"
            />
            <span class="unit-text">เมตร</span>
          </div>
        </div>
