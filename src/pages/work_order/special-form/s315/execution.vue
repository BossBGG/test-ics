...
<template>
  <content-container
    :breadcrumbs="[
      ...
      { text: 'สร้างใบสั่งงาน ขอเช่าหม้อแปลง' },
    ]"
  >
    <template #menu>
    ...
    <div v-if="currentStep === 0">
      ...
      <CustomerInfo :data="customerData" @update:data="updateCustomerData">
        ...
        <template #additional-content>
          ...
          @update:data="updateTransformerDate"
          />
    ...
    <div v-else-if="currentStep === 3">
      ...
      <CardCollapse title="วันที่เช่าหม้อแปลง" icon="/assets/images/doc.png">
        <TransformerDateSelector 
          :data="TransformerDate"
          @update:data="updateTransformerDate"
          />
      ...
      <CardCollapse title="หม้อแปลง" icon="/assets/images/doc.png">
        <TransformerList />
      </CardCollapse>
...
import TransformerDateSelector from "~/pages/work_order/special-form/s315/TransformerDateSelector.vue";
