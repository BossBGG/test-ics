...
<template>
  ...
  >
    ...
    <div v-else-if="currentStep === 3">
      ...
      <CardCollapse title="ประเภทคำร้อง" icon="/assets/images/doc.png">
        <BusinessType />
      </CardCollapse>

      <CardCollapse title="ประเภทการให้บริการ" icon="/assets/images/doc.png">
        <RequestServiceType />
      </CardCollapse>

      <CardCollapse title="รายละเอียดหม้อแปลง" icon="/assets/images/doc.png">
        <TransformerDetail />
      </CardCollapse>
...
import TransformerDetail from "~/pages/work_order/special-form/s305/TransformerDetail.vue";
