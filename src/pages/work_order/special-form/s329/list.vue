...
<template>
  <content-container
    :breadcrumbs="[
      ...
      { text: 'สร้างใบสั่งงาน ขอซื้อขายใบรับรองการผลิตพลังงานหมุนเวียน' },
    ]"
  >
    <template #menu>
      ...
      <CustomerInfo :data="customerData" @update:data="updateCustomerData">
        ...
        <template #additional-content>
          <CertificateRequirement
            v-model="certificateNeeded"
            @change="handleCertificateChange"
          />

          <EnergySourceSelector
            v-model="energySource"
            @change="handleEnergySourceChange"
          />

          <CertificateYearSelector
            v-model="yearData"
            @data-change="handleYearDataChange"
          />
        </template>
      </CustomerInfo>
    </div>
    ...
    <div v-else-if="currentStep === 3">
      ...
      <CardCollapse
        title="สำรวจความต้องการใบรับรองการผลิตพลังงานหมุนเวียน"
      ...
      <CardCollapse
        title="แหล่งที่มาของพลังงานหมุนเวียนที่ต้องการ"
        icon="/assets/images/doc.png"
      >
        <EnergySourceSelector
          v-model="energySource"
      ...
      <CardCollapse
        title="ปีที่มีความต้องการใบรับรองการผลิตพลังงานหมุนเวียน"
        icon="/assets/images/doc.png"
      >
        <CertificateYearSelector
          v-model="yearData"
